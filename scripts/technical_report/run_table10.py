...
if __name__ == "__main__":
    ...
    # beit
    beit_kitti_metric_absrel = read_evaluation_from_log(log_path_list[row_cnt * 10 + 0])['metric']['abs_rel']
    beit_nyu_metric_absrel = read_evaluation_from_log(log_path_list[row_cnt * 10 + 1])['metric']['abs_rel']
    beit_scannet_metric_absrel = read_evaluation_from_log(log_path_list[row_cnt * 10 + 2])['metric']['abs_rel']
    beit_sevenscenes_metric_absrel = read_evaluation_from_log(log_path_list[row_cnt * 10 + 3])['metric']['abs_rel']
    beit_diode_indoor_metric_absrel = read_evaluation_from_log(log_path_list[row_cnt * 10 + 4])['metric']['abs_rel']
    beit_diode_outdoor_metric_absrel = read_evaluation_from_log(log_path_list[row_cnt * 10 + 5])['metric']['abs_rel']
    beit_diode_metric_absrel = read_evaluation_from_log(log_path_list[row_cnt * 10 + 6])['metric']['abs_rel']
    beit_eth3d_metric_absrel = read_evaluation_from_log(log_path_list[row_cnt * 10 + 7])['metric']['abs_rel']
    beit_ibims_metric_absrel = read_evaluation_from_log(log_path_list[row_cnt * 10 + 8])['metric']['abs_rel']
    beit_nuscenes_metric_absrel = read_evaluation_from_log(log_path_list[row_cnt * 10 + 9])['metric']['abs_rel']

    row_cnt +=1


    # convnext
    convnext_kitti_metric_absrel = read_evaluation_from_log(log_path_list[row_cnt * 10 + 0])['metric']['abs_rel']
    convnext_nyu_metric_absrel = read_evaluation_from_log(log_path_list[row_cnt * 10 + 1])['metric']['abs_rel']
    convnext_scannet_metric_absrel = read_evaluation_from_log(log_path_list[row_cnt * 10 + 2])['metric']['abs_rel']
    convnext_sevenscenes_metric_absrel = read_evaluation_from_log(log_path_list[row_cnt * 10 + 3])['metric']['abs_rel']
    convnext_diode_indoor_metric_absrel = read_evaluation_from_log(log_path_list[row_cnt * 10 + 4])['metric']['abs_rel']
    convnext_diode_outdoor_metric_absrel = read_evaluation_from_log(log_path_list[row_cnt * 10 + 5])['metric']['abs_rel']
    convnext_diode_metric_absrel = read_evaluation_from_log(log_path_list[row_cnt * 10 + 6])['metric']['abs_rel']
    convnext_eth3d_metric_absrel = read_evaluation_from_log(log_path_list[row_cnt * 10 + 7])['metric']['abs_rel']
    convnext_ibims_metric_absrel = read_evaluation_from_log(log_path_list[row_cnt * 10 + 8])['metric']['abs_rel']
    convnext_nuscenes_metric_absrel = read_evaluation_from_log(log_path_list[row_cnt * 10 + 9])['metric']['abs_rel']
    row_cnt +=1


    # swin2
    swin2_kitti_metric_absrel = read_evaluation_from_log(log_path_list[row_cnt * 10 + 0])['metric']['abs_rel']
    swin2_nyu_metric_absrel = read_evaluation_from_log(log_path_list[row_cnt * 10 + 1])['metric']['abs_rel']
    swin2_scannet_metric_absrel = read_evaluation_from_log(log_path_list[row_cnt * 10 + 2])['metric']['abs_rel']
    swin2_sevenscenes_metric_absrel = read_evaluation_from_log(log_path_list[row_cnt * 10 + 3])['metric']['abs_rel']
    swin2_diode_indoor_metric_absrel = read_evaluation_from_log(log_path_list[row_cnt * 10 + 4])['metric']['abs_rel']
    swin2_diode_outdoor_metric_absrel = read_evaluation_from_log(log_path_list[row_cnt * 10 + 5])['metric']['abs_rel']
    swin2_diode_metric_absrel = read_evaluation_from_log(log_path_list[row_cnt * 10 + 6])['metric']['abs_rel']
    swin2_eth3d_metric_absrel = read_evaluation_from_log(log_path_list[row_cnt * 10 + 7])['metric']['abs_rel']
    swin2_ibims_metric_absrel = read_evaluation_from_log(log_path_list[row_cnt * 10 + 8])['metric']['abs_rel']
    swin2_nuscenes_metric_absrel = read_evaluation_from_log(log_path_list[row_cnt * 10 + 9])['metric']['abs_rel']
    row_cnt +=1
    ...
    table_data = [
        ...
        ["Ours_BEiT", beit_kitti_metric_absrel, beit_nyu_metric_absrel, beit_scannet_metric_absrel, beit_sevenscenes_metric_absrel, beit_diode_indoor_metric_absrel, beit_diode_outdoor_metric_absrel, beit_diode_metric_absrel, beit_eth3d_metric_absrel, beit_ibims_metric_absrel, beit_nuscenes_metric_absrel],
        ["Ours_ConvNext", convnext_kitti_metric_absrel, convnext_nyu_metric_absrel, convnext_scannet_metric_absrel, convnext_sevenscenes_metric_absrel, convnext_diode_indoor_metric_absrel, convnext_diode_outdoor_metric_absrel, convnext_diode_metric_absrel, convnext_eth3d_metric_absrel, convnext_ibims_metric_absrel, convnext_nuscenes_metric_absrel],
        ["Ours_Swin2", swin2_kitti_metric_absrel, swin2_nyu_metric_absrel, swin2_scannet_metric_absrel, swin2_sevenscenes_metric_absrel, swin2_diode_indoor_metric_absrel, swin2_diode_outdoor_metric_absrel, swin2_diode_metric_absrel, swin2_eth3d_metric_absrel, swin2_ibims_metric_absrel, swin2_nuscenes_metric_absrel],
    ]
