...
if __name__ == "__main__":
    ...
    # beit
    beit_kitti_median_delta1 = read_evaluation_from_log(log_path_list[row_cnt * 10 + 0])['median']['delta1']
    beit_nyu_median_delta1 = read_evaluation_from_log(log_path_list[row_cnt * 10 + 1])['median']['delta1']
    beit_scannet_median_delta1 = read_evaluation_from_log(log_path_list[row_cnt * 10 + 2])['median']['delta1']
    beit_sevenscenes_median_delta1 = read_evaluation_from_log(log_path_list[row_cnt * 10 + 3])['median']['delta1']
    beit_diode_indoor_median_delta1 = read_evaluation_from_log(log_path_list[row_cnt * 10 + 4])['median']['delta1']
    beit_diode_outdoor_median_delta1 = read_evaluation_from_log(log_path_list[row_cnt * 10 + 5])['median']['delta1']
    beit_diode_median_delta1 = read_evaluation_from_log(log_path_list[row_cnt * 10 + 6])['median']['delta1']
    beit_eth3d_median_delta1 = read_evaluation_from_log(log_path_list[row_cnt * 10 + 7])['median']['delta1']
    beit_ibims_median_delta1 = read_evaluation_from_log(log_path_list[row_cnt * 10 + 8])['median']['delta1']
    beit_nuscenes_median_delta1 = read_evaluation_from_log(log_path_list[row_cnt * 10 + 9])['median']['delta1']

    row_cnt +=1


    # convnext
    convnext_kitti_median_delta1 = read_evaluation_from_log(log_path_list[row_cnt * 10 + 0])['median']['delta1']
    convnext_nyu_median_delta1 = read_evaluation_from_log(log_path_list[row_cnt * 10 + 1])['median']['delta1']
    convnext_scannet_median_delta1 = read_evaluation_from_log(log_path_list[row_cnt * 10 + 2])['median']['delta1']
    convnext_sevenscenes_median_delta1 = read_evaluation_from_log(log_path_list[row_cnt * 10 + 3])['median']['delta1']
    convnext_diode_indoor_median_delta1 = read_evaluation_from_log(log_path_list[row_cnt * 10 + 4])['median']['delta1']
    convnext_diode_outdoor_median_delta1 = read_evaluation_from_log(log_path_list[row_cnt * 10 + 5])['median']['delta1']
    convnext_diode_median_delta1 = read_evaluation_from_log(log_path_list[row_cnt * 10 + 6])['median']['delta1']
    convnext_eth3d_median_delta1 = read_evaluation_from_log(log_path_list[row_cnt * 10 + 7])['median']['delta1']
    convnext_ibims_median_delta1 = read_evaluation_from_log(log_path_list[row_cnt * 10 + 8])['median']['delta1']
    convnext_nuscenes_median_delta1 = read_evaluation_from_log(log_path_list[row_cnt * 10 + 9])['median']['delta1']
    row_cnt +=1


    # swin2
    swin2_kitti_median_delta1 = read_evaluation_from_log(log_path_list[row_cnt * 10 + 0])['median']['delta1']
    swin2_nyu_median_delta1 = read_evaluation_from_log(log_path_list[row_cnt * 10 + 1])['median']['delta1']
    swin2_scannet_median_delta1 = read_evaluation_from_log(log_path_list[row_cnt * 10 + 2])['median']['delta1']
    swin2_sevenscenes_median_delta1 = read_evaluation_from_log(log_path_list[row_cnt * 10 + 3])['median']['delta1']
    swin2_diode_indoor_median_delta1 = read_evaluation_from_log(log_path_list[row_cnt * 10 + 4])['median']['delta1']
    swin2_diode_outdoor_median_delta1 = read_evaluation_from_log(log_path_list[row_cnt * 10 + 5])['median']['delta1']
    swin2_diode_median_delta1 = read_evaluation_from_log(log_path_list[row_cnt * 10 + 6])['median']['delta1']
    swin2_eth3d_median_delta1 = read_evaluation_from_log(log_path_list[row_cnt * 10 + 7])['median']['delta1']
    swin2_ibims_median_delta1 = read_evaluation_from_log(log_path_list[row_cnt * 10 + 8])['median']['delta1']
    swin2_nuscenes_median_delta1 = read_evaluation_from_log(log_path_list[row_cnt * 10 + 9])['median']['delta1']
    row_cnt +=1
    ...
    table_data = [
        ...
        ["Ours_BEiT", beit_kitti_median_delta1, beit_nyu_median_delta1, beit_scannet_median_delta1, beit_sevenscenes_median_delta1, beit_diode_indoor_median_delta1, beit_diode_outdoor_median_delta1, beit_diode_median_delta1, beit_eth3d_median_delta1, beit_ibims_median_delta1, beit_nuscenes_median_delta1],
        ["Ours_ConvNext", convnext_kitti_median_delta1, convnext_nyu_median_delta1, convnext_scannet_median_delta1, convnext_sevenscenes_median_delta1, convnext_diode_indoor_median_delta1, convnext_diode_outdoor_median_delta1, convnext_diode_median_delta1, convnext_eth3d_median_delta1, convnext_ibims_median_delta1, convnext_nuscenes_median_delta1],
        ["Ours_Swin2", swin2_kitti_median_delta1, swin2_nyu_median_delta1, swin2_scannet_median_delta1, swin2_sevenscenes_median_delta1, swin2_diode_indoor_median_delta1, swin2_diode_outdoor_median_delta1, swin2_diode_median_delta1, swin2_eth3d_median_delta1, swin2_ibims_median_delta1, swin2_nuscenes_median_delta1],
    ]
