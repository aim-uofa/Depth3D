...
if __name__ == "__main__":
    ...
    # beit
    beit_kitti_global_delta1 = read_evaluation_from_log(log_path_list[row_cnt * 10 + 0])['global']['delta1']
    beit_nyu_global_delta1 = read_evaluation_from_log(log_path_list[row_cnt * 10 + 1])['global']['delta1']
    beit_scannet_global_delta1 = read_evaluation_from_log(log_path_list[row_cnt * 10 + 2])['global']['delta1']
    beit_sevenscenes_global_delta1 = read_evaluation_from_log(log_path_list[row_cnt * 10 + 3])['global']['delta1']
    beit_diode_indoor_global_delta1 = read_evaluation_from_log(log_path_list[row_cnt * 10 + 4])['global']['delta1']
    beit_diode_outdoor_global_delta1 = read_evaluation_from_log(log_path_list[row_cnt * 10 + 5])['global']['delta1']
    beit_diode_global_delta1 = read_evaluation_from_log(log_path_list[row_cnt * 10 + 6])['global']['delta1']
    beit_eth3d_global_delta1 = read_evaluation_from_log(log_path_list[row_cnt * 10 + 7])['global']['delta1']
    beit_ibims_global_delta1 = read_evaluation_from_log(log_path_list[row_cnt * 10 + 8])['global']['delta1']
    beit_nuscenes_global_delta1 = read_evaluation_from_log(log_path_list[row_cnt * 10 + 9])['global']['delta1']

    row_cnt +=1


    # convnext
    convnext_kitti_global_delta1 = read_evaluation_from_log(log_path_list[row_cnt * 10 + 0])['global']['delta1']
    convnext_nyu_global_delta1 = read_evaluation_from_log(log_path_list[row_cnt * 10 + 1])['global']['delta1']
    convnext_scannet_global_delta1 = read_evaluation_from_log(log_path_list[row_cnt * 10 + 2])['global']['delta1']
    convnext_sevenscenes_global_delta1 = read_evaluation_from_log(log_path_list[row_cnt * 10 + 3])['global']['delta1']
    convnext_diode_indoor_global_delta1 = read_evaluation_from_log(log_path_list[row_cnt * 10 + 4])['global']['delta1']
    convnext_diode_outdoor_global_delta1 = read_evaluation_from_log(log_path_list[row_cnt * 10 + 5])['global']['delta1']
    convnext_diode_global_delta1 = read_evaluation_from_log(log_path_list[row_cnt * 10 + 6])['global']['delta1']
    convnext_eth3d_global_delta1 = read_evaluation_from_log(log_path_list[row_cnt * 10 + 7])['global']['delta1']
    convnext_ibims_global_delta1 = read_evaluation_from_log(log_path_list[row_cnt * 10 + 8])['global']['delta1']
    convnext_nuscenes_global_delta1 = read_evaluation_from_log(log_path_list[row_cnt * 10 + 9])['global']['delta1']
    row_cnt +=1


    # swin2
    swin2_kitti_global_delta1 = read_evaluation_from_log(log_path_list[row_cnt * 10 + 0])['global']['delta1']
    swin2_nyu_global_delta1 = read_evaluation_from_log(log_path_list[row_cnt * 10 + 1])['global']['delta1']
    swin2_scannet_global_delta1 = read_evaluation_from_log(log_path_list[row_cnt * 10 + 2])['global']['delta1']
    swin2_sevenscenes_global_delta1 = read_evaluation_from_log(log_path_list[row_cnt * 10 + 3])['global']['delta1']
    swin2_diode_indoor_global_delta1 = read_evaluation_from_log(log_path_list[row_cnt * 10 + 4])['global']['delta1']
    swin2_diode_outdoor_global_delta1 = read_evaluation_from_log(log_path_list[row_cnt * 10 + 5])['global']['delta1']
    swin2_diode_global_delta1 = read_evaluation_from_log(log_path_list[row_cnt * 10 + 6])['global']['delta1']
    swin2_eth3d_global_delta1 = read_evaluation_from_log(log_path_list[row_cnt * 10 + 7])['global']['delta1']
    swin2_ibims_global_delta1 = read_evaluation_from_log(log_path_list[row_cnt * 10 + 8])['global']['delta1']
    swin2_nuscenes_global_delta1 = read_evaluation_from_log(log_path_list[row_cnt * 10 + 9])['global']['delta1']
    row_cnt +=1
    ...
    table_data = [
        ...
        ["Ours_BEiT", beit_kitti_global_delta1, beit_nyu_global_delta1, beit_scannet_global_delta1, beit_sevenscenes_global_delta1, beit_diode_indoor_global_delta1, beit_diode_outdoor_global_delta1, beit_diode_global_delta1, beit_eth3d_global_delta1, beit_ibims_global_delta1, beit_nuscenes_global_delta1],
        ["Ours_ConvNext", convnext_kitti_global_delta1, convnext_nyu_global_delta1, convnext_scannet_global_delta1, convnext_sevenscenes_global_delta1, convnext_diode_indoor_global_delta1, convnext_diode_outdoor_global_delta1, convnext_diode_global_delta1, convnext_eth3d_global_delta1, convnext_ibims_global_delta1, convnext_nuscenes_global_delta1],
        ["Ours_Swin2", swin2_kitti_global_delta1, swin2_nyu_global_delta1, swin2_scannet_global_delta1, swin2_sevenscenes_global_delta1, swin2_diode_indoor_global_delta1, swin2_diode_outdoor_global_delta1, swin2_diode_global_delta1, swin2_eth3d_global_delta1, swin2_ibims_global_delta1, swin2_nuscenes_global_delta1],
    ]
