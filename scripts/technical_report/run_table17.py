...
if __name__ == "__main__":
    ...
    # beit
    beit_kitti_global_rmse = read_evaluation_from_log(log_path_list[row_cnt * 10 + 0])['global']['rmse']
    beit_nyu_global_rmse = read_evaluation_from_log(log_path_list[row_cnt * 10 + 1])['global']['rmse']
    beit_scannet_global_rmse = read_evaluation_from_log(log_path_list[row_cnt * 10 + 2])['global']['rmse']
    beit_sevenscenes_global_rmse = read_evaluation_from_log(log_path_list[row_cnt * 10 + 3])['global']['rmse']
    beit_diode_indoor_global_rmse = read_evaluation_from_log(log_path_list[row_cnt * 10 + 4])['global']['rmse']
    beit_diode_outdoor_global_rmse = read_evaluation_from_log(log_path_list[row_cnt * 10 + 5])['global']['rmse']
    beit_diode_global_rmse = read_evaluation_from_log(log_path_list[row_cnt * 10 + 6])['global']['rmse']
    beit_eth3d_global_rmse = read_evaluation_from_log(log_path_list[row_cnt * 10 + 7])['global']['rmse']
    beit_ibims_global_rmse = read_evaluation_from_log(log_path_list[row_cnt * 10 + 8])['global']['rmse']
    beit_nuscenes_global_rmse = read_evaluation_from_log(log_path_list[row_cnt * 10 + 9])['global']['rmse']

    row_cnt +=1


    # convnext
    convnext_kitti_global_rmse = read_evaluation_from_log(log_path_list[row_cnt * 10 + 0])['global']['rmse']
    convnext_nyu_global_rmse = read_evaluation_from_log(log_path_list[row_cnt * 10 + 1])['global']['rmse']
    convnext_scannet_global_rmse = read_evaluation_from_log(log_path_list[row_cnt * 10 + 2])['global']['rmse']
    convnext_sevenscenes_global_rmse = read_evaluation_from_log(log_path_list[row_cnt * 10 + 3])['global']['rmse']
    convnext_diode_indoor_global_rmse = read_evaluation_from_log(log_path_list[row_cnt * 10 + 4])['global']['rmse']
    convnext_diode_outdoor_global_rmse = read_evaluation_from_log(log_path_list[row_cnt * 10 + 5])['global']['rmse']
    convnext_diode_global_rmse = read_evaluation_from_log(log_path_list[row_cnt * 10 + 6])['global']['rmse']
    convnext_eth3d_global_rmse = read_evaluation_from_log(log_path_list[row_cnt * 10 + 7])['global']['rmse']
    convnext_ibims_global_rmse = read_evaluation_from_log(log_path_list[row_cnt * 10 + 8])['global']['rmse']
    convnext_nuscenes_global_rmse = read_evaluation_from_log(log_path_list[row_cnt * 10 + 9])['global']['rmse']
    row_cnt +=1


    # swin2
    swin2_kitti_global_rmse = read_evaluation_from_log(log_path_list[row_cnt * 10 + 0])['global']['rmse']
    swin2_nyu_global_rmse = read_evaluation_from_log(log_path_list[row_cnt * 10 + 1])['global']['rmse']
    swin2_scannet_global_rmse = read_evaluation_from_log(log_path_list[row_cnt * 10 + 2])['global']['rmse']
    swin2_sevenscenes_global_rmse = read_evaluation_from_log(log_path_list[row_cnt * 10 + 3])['global']['rmse']
    swin2_diode_indoor_global_rmse = read_evaluation_from_log(log_path_list[row_cnt * 10 + 4])['global']['rmse']
    swin2_diode_outdoor_global_rmse = read_evaluation_from_log(log_path_list[row_cnt * 10 + 5])['global']['rmse']
    swin2_diode_global_rmse = read_evaluation_from_log(log_path_list[row_cnt * 10 + 6])['global']['rmse']
    swin2_eth3d_global_rmse = read_evaluation_from_log(log_path_list[row_cnt * 10 + 7])['global']['rmse']
    swin2_ibims_global_rmse = read_evaluation_from_log(log_path_list[row_cnt * 10 + 8])['global']['rmse']
    swin2_nuscenes_global_rmse = read_evaluation_from_log(log_path_list[row_cnt * 10 + 9])['global']['rmse']
    row_cnt +=1
    ...
    table_data = [
        ...
        ["Ours_BEiT", beit_kitti_global_rmse, beit_nyu_global_rmse, beit_scannet_global_rmse, beit_sevenscenes_global_rmse, beit_diode_indoor_global_rmse, beit_diode_outdoor_global_rmse, beit_diode_global_rmse, beit_eth3d_global_rmse, beit_ibims_global_rmse, beit_nuscenes_global_rmse],
        ["Ours_ConvNext", convnext_kitti_global_rmse, convnext_nyu_global_rmse, convnext_scannet_global_rmse, convnext_sevenscenes_global_rmse, convnext_diode_indoor_global_rmse, convnext_diode_outdoor_global_rmse, convnext_diode_global_rmse, convnext_eth3d_global_rmse, convnext_ibims_global_rmse, convnext_nuscenes_global_rmse],
        ["Ours_Swin2", swin2_kitti_global_rmse, swin2_nyu_global_rmse, swin2_scannet_global_rmse, swin2_sevenscenes_global_rmse, swin2_diode_indoor_global_rmse, swin2_diode_outdoor_global_rmse, swin2_diode_global_rmse, swin2_eth3d_global_rmse, swin2_ibims_global_rmse, swin2_nuscenes_global_rmse],
    ]
