...
if __name__ == "__main__":
    ...
    # beit
    beit_kitti_metric_delta1 = read_evaluation_from_log(log_path_list[row_cnt * 10 + 0])['metric']['delta1']
    beit_nyu_metric_delta1 = read_evaluation_from_log(log_path_list[row_cnt * 10 + 1])['metric']['delta1']
    beit_scannet_metric_delta1 = read_evaluation_from_log(log_path_list[row_cnt * 10 + 2])['metric']['delta1']
    beit_sevenscenes_metric_delta1 = read_evaluation_from_log(log_path_list[row_cnt * 10 + 3])['metric']['delta1']
    beit_diode_indoor_metric_delta1 = read_evaluation_from_log(log_path_list[row_cnt * 10 + 4])['metric']['delta1']
    beit_diode_outdoor_metric_delta1 = read_evaluation_from_log(log_path_list[row_cnt * 10 + 5])['metric']['delta1']
    beit_diode_metric_delta1 = read_evaluation_from_log(log_path_list[row_cnt * 10 + 6])['metric']['delta1']
    beit_eth3d_metric_delta1 = read_evaluation_from_log(log_path_list[row_cnt * 10 + 7])['metric']['delta1']
    beit_ibims_metric_delta1 = read_evaluation_from_log(log_path_list[row_cnt * 10 + 8])['metric']['delta1']
    beit_nuscenes_metric_delta1 = read_evaluation_from_log(log_path_list[row_cnt * 10 + 9])['metric']['delta1']

    row_cnt +=1


    # convnext
    convnext_kitti_metric_delta1 = read_evaluation_from_log(log_path_list[row_cnt * 10 + 0])['metric']['delta1']
    convnext_nyu_metric_delta1 = read_evaluation_from_log(log_path_list[row_cnt * 10 + 1])['metric']['delta1']
    convnext_scannet_metric_delta1 = read_evaluation_from_log(log_path_list[row_cnt * 10 + 2])['metric']['delta1']
    convnext_sevenscenes_metric_delta1 = read_evaluation_from_log(log_path_list[row_cnt * 10 + 3])['metric']['delta1']
    convnext_diode_indoor_metric_delta1 = read_evaluation_from_log(log_path_list[row_cnt * 10 + 4])['metric']['delta1']
    convnext_diode_outdoor_metric_delta1 = read_evaluation_from_log(log_path_list[row_cnt * 10 + 5])['metric']['delta1']
    convnext_diode_metric_delta1 = read_evaluation_from_log(log_path_list[row_cnt * 10 + 6])['metric']['delta1']
    convnext_eth3d_metric_delta1 = read_evaluation_from_log(log_path_list[row_cnt * 10 + 7])['metric']['delta1']
    convnext_ibims_metric_delta1 = read_evaluation_from_log(log_path_list[row_cnt * 10 + 8])['metric']['delta1']
    convnext_nuscenes_metric_delta1 = read_evaluation_from_log(log_path_list[row_cnt * 10 + 9])['metric']['delta1']
    row_cnt +=1


    # swin2
    swin2_kitti_metric_delta1 = read_evaluation_from_log(log_path_list[row_cnt * 10 + 0])['metric']['delta1']
    swin2_nyu_metric_delta1 = read_evaluation_from_log(log_path_list[row_cnt * 10 + 1])['metric']['delta1']
    swin2_scannet_metric_delta1 = read_evaluation_from_log(log_path_list[row_cnt * 10 + 2])['metric']['delta1']
    swin2_sevenscenes_metric_delta1 = read_evaluation_from_log(log_path_list[row_cnt * 10 + 3])['metric']['delta1']
    swin2_diode_indoor_metric_delta1 = read_evaluation_from_log(log_path_list[row_cnt * 10 + 4])['metric']['delta1']
    swin2_diode_outdoor_metric_delta1 = read_evaluation_from_log(log_path_list[row_cnt * 10 + 5])['metric']['delta1']
    swin2_diode_metric_delta1 = read_evaluation_from_log(log_path_list[row_cnt * 10 + 6])['metric']['delta1']
    swin2_eth3d_metric_delta1 = read_evaluation_from_log(log_path_list[row_cnt * 10 + 7])['metric']['delta1']
    swin2_ibims_metric_delta1 = read_evaluation_from_log(log_path_list[row_cnt * 10 + 8])['metric']['delta1']
    swin2_nuscenes_metric_delta1 = read_evaluation_from_log(log_path_list[row_cnt * 10 + 9])['metric']['delta1']
    row_cnt +=1


    # print results
    print('**********Final Evaluation Results of delta1 are shown as follows**********\nWe show the metric depth evaluation results and do not use any alignment with ground-truth depth.')

    table_data = [
        ["Method", "KITTI", "NYU", "ScanNet", "7-Scenes", "DIODE(indoor)", "DIODE(outdoor)", "DIODE", "ETH3D", "iBIMS-1", "NuScenes"],
        ["Ours_BEiT", beit_kitti_metric_delta1, beit_nyu_metric_delta1, beit_scannet_metric_delta1, beit_sevenscenes_metric_delta1, beit_diode_indoor_metric_delta1, beit_diode_outdoor_metric_delta1, beit_diode_metric_delta1, beit_eth3d_metric_delta1, beit_ibims_metric_delta1, beit_nuscenes_metric_delta1],
        ["Ours_ConvNext", convnext_kitti_metric_delta1, convnext_nyu_metric_delta1, convnext_scannet_metric_delta1, convnext_sevenscenes_metric_delta1, convnext_diode_indoor_metric_delta1, convnext_diode_outdoor_metric_delta1, convnext_diode_metric_delta1, convnext_eth3d_metric_delta1, convnext_ibims_metric_delta1, convnext_nuscenes_metric_delta1],
        ["Ours_Swin2", swin2_kitti_metric_delta1, swin2_nyu_metric_delta1, swin2_scannet_metric_delta1, swin2_sevenscenes_metric_delta1, swin2_diode_indoor_metric_delta1, swin2_diode_outdoor_metric_delta1, swin2_diode_metric_delta1, swin2_eth3d_metric_delta1, swin2_ibims_metric_delta1, swin2_nuscenes_metric_delta1],
    ]
