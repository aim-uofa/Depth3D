...
if __name__ == "__main__":
    ...
    # beit
    beit_kitti_metric_rmse = read_evaluation_from_log(log_path_list[row_cnt * 10 + 0])['metric']['rmse']
    beit_nyu_metric_rmse = read_evaluation_from_log(log_path_list[row_cnt * 10 + 1])['metric']['rmse']
    beit_scannet_metric_rmse = read_evaluation_from_log(log_path_list[row_cnt * 10 + 2])['metric']['rmse']
    beit_sevenscenes_metric_rmse = read_evaluation_from_log(log_path_list[row_cnt * 10 + 3])['metric']['rmse']
    beit_diode_indoor_metric_rmse = read_evaluation_from_log(log_path_list[row_cnt * 10 + 4])['metric']['rmse']
    beit_diode_outdoor_metric_rmse = read_evaluation_from_log(log_path_list[row_cnt * 10 + 5])['metric']['rmse']
    beit_diode_metric_rmse = read_evaluation_from_log(log_path_list[row_cnt * 10 + 6])['metric']['rmse']
    beit_eth3d_metric_rmse = read_evaluation_from_log(log_path_list[row_cnt * 10 + 7])['metric']['rmse']
    beit_ibims_metric_rmse = read_evaluation_from_log(log_path_list[row_cnt * 10 + 8])['metric']['rmse']
    beit_nuscenes_metric_rmse = read_evaluation_from_log(log_path_list[row_cnt * 10 + 9])['metric']['rmse']

    row_cnt +=1


    # convnext
    convnext_kitti_metric_rmse = read_evaluation_from_log(log_path_list[row_cnt * 10 + 0])['metric']['rmse']
    convnext_nyu_metric_rmse = read_evaluation_from_log(log_path_list[row_cnt * 10 + 1])['metric']['rmse']
    convnext_scannet_metric_rmse = read_evaluation_from_log(log_path_list[row_cnt * 10 + 2])['metric']['rmse']
    convnext_sevenscenes_metric_rmse = read_evaluation_from_log(log_path_list[row_cnt * 10 + 3])['metric']['rmse']
    convnext_diode_indoor_metric_rmse = read_evaluation_from_log(log_path_list[row_cnt * 10 + 4])['metric']['rmse']
    convnext_diode_outdoor_metric_rmse = read_evaluation_from_log(log_path_list[row_cnt * 10 + 5])['metric']['rmse']
    convnext_diode_metric_rmse = read_evaluation_from_log(log_path_list[row_cnt * 10 + 6])['metric']['rmse']
    convnext_eth3d_metric_rmse = read_evaluation_from_log(log_path_list[row_cnt * 10 + 7])['metric']['rmse']
    convnext_ibims_metric_rmse = read_evaluation_from_log(log_path_list[row_cnt * 10 + 8])['metric']['rmse']
    convnext_nuscenes_metric_rmse = read_evaluation_from_log(log_path_list[row_cnt * 10 + 9])['metric']['rmse']
    row_cnt +=1


    # swin2
    swin2_kitti_metric_rmse = read_evaluation_from_log(log_path_list[row_cnt * 10 + 0])['metric']['rmse']
    swin2_nyu_metric_rmse = read_evaluation_from_log(log_path_list[row_cnt * 10 + 1])['metric']['rmse']
    swin2_scannet_metric_rmse = read_evaluation_from_log(log_path_list[row_cnt * 10 + 2])['metric']['rmse']
    swin2_sevenscenes_metric_rmse = read_evaluation_from_log(log_path_list[row_cnt * 10 + 3])['metric']['rmse']
    swin2_diode_indoor_metric_rmse = read_evaluation_from_log(log_path_list[row_cnt * 10 + 4])['metric']['rmse']
    swin2_diode_outdoor_metric_rmse = read_evaluation_from_log(log_path_list[row_cnt * 10 + 5])['metric']['rmse']
    swin2_diode_metric_rmse = read_evaluation_from_log(log_path_list[row_cnt * 10 + 6])['metric']['rmse']
    swin2_eth3d_metric_rmse = read_evaluation_from_log(log_path_list[row_cnt * 10 + 7])['metric']['rmse']
    swin2_ibims_metric_rmse = read_evaluation_from_log(log_path_list[row_cnt * 10 + 8])['metric']['rmse']
    swin2_nuscenes_metric_rmse = read_evaluation_from_log(log_path_list[row_cnt * 10 + 9])['metric']['rmse']
    row_cnt +=1


    # print results
    print('**********Final Evaluation Results of RMSE are shown as follows**********\nWe show the metric depth evaluation results and do not use any alignment with ground-truth depth.')

    table_data = [
        ["Method", "KITTI", "NYU", "ScanNet", "7-Scenes", "DIODE(indoor)", "DIODE(outdoor)", "DIODE", "ETH3D", "iBIMS-1", "NuScenes"],
        ["Ours_BEiT", beit_kitti_metric_rmse, beit_nyu_metric_rmse, beit_scannet_metric_rmse, beit_sevenscenes_metric_rmse, beit_diode_indoor_metric_rmse, beit_diode_outdoor_metric_rmse, beit_diode_metric_rmse, beit_eth3d_metric_rmse, beit_ibims_metric_rmse, beit_nuscenes_metric_rmse],
        ["Ours_ConvNext", convnext_kitti_metric_rmse, convnext_nyu_metric_rmse, convnext_scannet_metric_rmse, convnext_sevenscenes_metric_rmse, convnext_diode_indoor_metric_rmse, convnext_diode_outdoor_metric_rmse, convnext_diode_metric_rmse, convnext_eth3d_metric_rmse, convnext_ibims_metric_rmse, convnext_nuscenes_metric_rmse],
        ["Ours_Swin2", swin2_kitti_metric_rmse, swin2_nyu_metric_rmse, swin2_scannet_metric_rmse, swin2_sevenscenes_metric_rmse, swin2_diode_indoor_metric_rmse, swin2_diode_outdoor_metric_rmse, swin2_diode_metric_rmse, swin2_eth3d_metric_rmse, swin2_ibims_metric_rmse, swin2_nuscenes_metric_rmse],
    ]
