...
if __name__ == "__main__":
    ...
    # beit
    beit_kitti_median_rmse = read_evaluation_from_log(log_path_list[row_cnt * 10 + 0])['median']['rmse']
    beit_nyu_median_rmse = read_evaluation_from_log(log_path_list[row_cnt * 10 + 1])['median']['rmse']
    beit_scannet_median_rmse = read_evaluation_from_log(log_path_list[row_cnt * 10 + 2])['median']['rmse']
    beit_sevenscenes_median_rmse = read_evaluation_from_log(log_path_list[row_cnt * 10 + 3])['median']['rmse']
    beit_diode_indoor_median_rmse = read_evaluation_from_log(log_path_list[row_cnt * 10 + 4])['median']['rmse']
    beit_diode_outdoor_median_rmse = read_evaluation_from_log(log_path_list[row_cnt * 10 + 5])['median']['rmse']
    beit_diode_median_rmse = read_evaluation_from_log(log_path_list[row_cnt * 10 + 6])['median']['rmse']
    beit_eth3d_median_rmse = read_evaluation_from_log(log_path_list[row_cnt * 10 + 7])['median']['rmse']
    beit_ibims_median_rmse = read_evaluation_from_log(log_path_list[row_cnt * 10 + 8])['median']['rmse']
    beit_nuscenes_median_rmse = read_evaluation_from_log(log_path_list[row_cnt * 10 + 9])['median']['rmse']

    row_cnt +=1


    # convnext
    convnext_kitti_median_rmse = read_evaluation_from_log(log_path_list[row_cnt * 10 + 0])['median']['rmse']
    convnext_nyu_median_rmse = read_evaluation_from_log(log_path_list[row_cnt * 10 + 1])['median']['rmse']
    convnext_scannet_median_rmse = read_evaluation_from_log(log_path_list[row_cnt * 10 + 2])['median']['rmse']
    convnext_sevenscenes_median_rmse = read_evaluation_from_log(log_path_list[row_cnt * 10 + 3])['median']['rmse']
    convnext_diode_indoor_median_rmse = read_evaluation_from_log(log_path_list[row_cnt * 10 + 4])['median']['rmse']
    convnext_diode_outdoor_median_rmse = read_evaluation_from_log(log_path_list[row_cnt * 10 + 5])['median']['rmse']
    convnext_diode_median_rmse = read_evaluation_from_log(log_path_list[row_cnt * 10 + 6])['median']['rmse']
    convnext_eth3d_median_rmse = read_evaluation_from_log(log_path_list[row_cnt * 10 + 7])['median']['rmse']
    convnext_ibims_median_rmse = read_evaluation_from_log(log_path_list[row_cnt * 10 + 8])['median']['rmse']
    convnext_nuscenes_median_rmse = read_evaluation_from_log(log_path_list[row_cnt * 10 + 9])['median']['rmse']
    row_cnt +=1


    # swin2
    swin2_kitti_median_rmse = read_evaluation_from_log(log_path_list[row_cnt * 10 + 0])['median']['rmse']
    swin2_nyu_median_rmse = read_evaluation_from_log(log_path_list[row_cnt * 10 + 1])['median']['rmse']
    swin2_scannet_median_rmse = read_evaluation_from_log(log_path_list[row_cnt * 10 + 2])['median']['rmse']
    swin2_sevenscenes_median_rmse = read_evaluation_from_log(log_path_list[row_cnt * 10 + 3])['median']['rmse']
    swin2_diode_indoor_median_rmse = read_evaluation_from_log(log_path_list[row_cnt * 10 + 4])['median']['rmse']
    swin2_diode_outdoor_median_rmse = read_evaluation_from_log(log_path_list[row_cnt * 10 + 5])['median']['rmse']
    swin2_diode_median_rmse = read_evaluation_from_log(log_path_list[row_cnt * 10 + 6])['median']['rmse']
    swin2_eth3d_median_rmse = read_evaluation_from_log(log_path_list[row_cnt * 10 + 7])['median']['rmse']
    swin2_ibims_median_rmse = read_evaluation_from_log(log_path_list[row_cnt * 10 + 8])['median']['rmse']
    swin2_nuscenes_median_rmse = read_evaluation_from_log(log_path_list[row_cnt * 10 + 9])['median']['rmse']
    row_cnt +=1
    ...
    table_data = [
        ...
        ["Ours_BEiT", beit_kitti_median_rmse, beit_nyu_median_rmse, beit_scannet_median_rmse, beit_sevenscenes_median_rmse, beit_diode_indoor_median_rmse, beit_diode_outdoor_median_rmse, beit_diode_median_rmse, beit_eth3d_median_rmse, beit_ibims_median_rmse, beit_nuscenes_median_rmse],
        ["Ours_ConvNext", convnext_kitti_median_rmse, convnext_nyu_median_rmse, convnext_scannet_median_rmse, convnext_sevenscenes_median_rmse, convnext_diode_indoor_median_rmse, convnext_diode_outdoor_median_rmse, convnext_diode_median_rmse, convnext_eth3d_median_rmse, convnext_ibims_median_rmse, convnext_nuscenes_median_rmse],
        ["Ours_Swin2", swin2_kitti_median_rmse, swin2_nyu_median_rmse, swin2_scannet_median_rmse, swin2_sevenscenes_median_rmse, swin2_diode_indoor_median_rmse, swin2_diode_outdoor_median_rmse, swin2_diode_median_rmse, swin2_eth3d_median_rmse, swin2_ibims_median_rmse, swin2_nuscenes_median_rmse],
    ]
