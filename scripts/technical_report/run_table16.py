...
if __name__ == "__main__":
    ...
    # beit
    beit_kitti_global_abs_rel = read_evaluation_from_log(log_path_list[row_cnt * 10 + 0])['global']['abs_rel']
    beit_nyu_global_abs_rel = read_evaluation_from_log(log_path_list[row_cnt * 10 + 1])['global']['abs_rel']
    beit_scannet_global_abs_rel = read_evaluation_from_log(log_path_list[row_cnt * 10 + 2])['global']['abs_rel']
    beit_sevenscenes_global_abs_rel = read_evaluation_from_log(log_path_list[row_cnt * 10 + 3])['global']['abs_rel']
    beit_diode_indoor_global_abs_rel = read_evaluation_from_log(log_path_list[row_cnt * 10 + 4])['global']['abs_rel']
    beit_diode_outdoor_global_abs_rel = read_evaluation_from_log(log_path_list[row_cnt * 10 + 5])['global']['abs_rel']
    beit_diode_global_abs_rel = read_evaluation_from_log(log_path_list[row_cnt * 10 + 6])['global']['abs_rel']
    beit_eth3d_global_abs_rel = read_evaluation_from_log(log_path_list[row_cnt * 10 + 7])['global']['abs_rel']
    beit_ibims_global_abs_rel = read_evaluation_from_log(log_path_list[row_cnt * 10 + 8])['global']['abs_rel']
    beit_nuscenes_global_abs_rel = read_evaluation_from_log(log_path_list[row_cnt * 10 + 9])['global']['abs_rel']

    row_cnt +=1


    # convnext
    convnext_kitti_global_abs_rel = read_evaluation_from_log(log_path_list[row_cnt * 10 + 0])['global']['abs_rel']
    convnext_nyu_global_abs_rel = read_evaluation_from_log(log_path_list[row_cnt * 10 + 1])['global']['abs_rel']
    convnext_scannet_global_abs_rel = read_evaluation_from_log(log_path_list[row_cnt * 10 + 2])['global']['abs_rel']
    convnext_sevenscenes_global_abs_rel = read_evaluation_from_log(log_path_list[row_cnt * 10 + 3])['global']['abs_rel']
    convnext_diode_indoor_global_abs_rel = read_evaluation_from_log(log_path_list[row_cnt * 10 + 4])['global']['abs_rel']
    convnext_diode_outdoor_global_abs_rel = read_evaluation_from_log(log_path_list[row_cnt * 10 + 5])['global']['abs_rel']
    convnext_diode_global_abs_rel = read_evaluation_from_log(log_path_list[row_cnt * 10 + 6])['global']['abs_rel']
    convnext_eth3d_global_abs_rel = read_evaluation_from_log(log_path_list[row_cnt * 10 + 7])['global']['abs_rel']
    convnext_ibims_global_abs_rel = read_evaluation_from_log(log_path_list[row_cnt * 10 + 8])['global']['abs_rel']
    convnext_nuscenes_global_abs_rel = read_evaluation_from_log(log_path_list[row_cnt * 10 + 9])['global']['abs_rel']
    row_cnt +=1


    # swin2
    swin2_kitti_global_abs_rel = read_evaluation_from_log(log_path_list[row_cnt * 10 + 0])['global']['abs_rel']
    swin2_nyu_global_abs_rel = read_evaluation_from_log(log_path_list[row_cnt * 10 + 1])['global']['abs_rel']
    swin2_scannet_global_abs_rel = read_evaluation_from_log(log_path_list[row_cnt * 10 + 2])['global']['abs_rel']
    swin2_sevenscenes_global_abs_rel = read_evaluation_from_log(log_path_list[row_cnt * 10 + 3])['global']['abs_rel']
    swin2_diode_indoor_global_abs_rel = read_evaluation_from_log(log_path_list[row_cnt * 10 + 4])['global']['abs_rel']
    swin2_diode_outdoor_global_abs_rel = read_evaluation_from_log(log_path_list[row_cnt * 10 + 5])['global']['abs_rel']
    swin2_diode_global_abs_rel = read_evaluation_from_log(log_path_list[row_cnt * 10 + 6])['global']['abs_rel']
    swin2_eth3d_global_abs_rel = read_evaluation_from_log(log_path_list[row_cnt * 10 + 7])['global']['abs_rel']
    swin2_ibims_global_abs_rel = read_evaluation_from_log(log_path_list[row_cnt * 10 + 8])['global']['abs_rel']
    swin2_nuscenes_global_abs_rel = read_evaluation_from_log(log_path_list[row_cnt * 10 + 9])['global']['abs_rel']
    row_cnt +=1
    ...
    table_data = [
        ...
        ["Ours_BEiT", beit_kitti_global_abs_rel, beit_nyu_global_abs_rel, beit_scannet_global_abs_rel, beit_sevenscenes_global_abs_rel, beit_diode_indoor_global_abs_rel, beit_diode_outdoor_global_abs_rel, beit_diode_global_abs_rel, beit_eth3d_global_abs_rel, beit_ibims_global_abs_rel, beit_nuscenes_global_abs_rel],
        ["Ours_ConvNext", convnext_kitti_global_abs_rel, convnext_nyu_global_abs_rel, convnext_scannet_global_abs_rel, convnext_sevenscenes_global_abs_rel, convnext_diode_indoor_global_abs_rel, convnext_diode_outdoor_global_abs_rel, convnext_diode_global_abs_rel, convnext_eth3d_global_abs_rel, convnext_ibims_global_abs_rel, convnext_nuscenes_global_abs_rel],
        ["Ours_Swin2", swin2_kitti_global_abs_rel, swin2_nyu_global_abs_rel, swin2_scannet_global_abs_rel, swin2_sevenscenes_global_abs_rel, swin2_diode_indoor_global_abs_rel, swin2_diode_outdoor_global_abs_rel, swin2_diode_global_abs_rel, swin2_eth3d_global_abs_rel, swin2_ibims_global_abs_rel, swin2_nuscenes_global_abs_rel],
    ]
