...
class EdgeguidedNormalLoss(nn.Module):
    def __init__(self, point_pairs=10000, cos_theta1=0.25, cos_theta2=0.98, cos_theta3=0.5, cos_theta4=0.86, mask_value=1e-8, loss_weight=1.0, data_type=['sfm', 'stereo', 'lidar'], **kwargs):
