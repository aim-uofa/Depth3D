...
Cityscapes_dataset=dict(
    ...
    train=dict(
        anno_path='Cityscapes_sequence/annotations/train_annotations.json',
        sample_ratio = 1.0,
        sample_size = -1,
    ...
    # configs for the training pipeline
    val=dict(
        anno_path='Cityscapes_sequence/annotations/val_annotations.json',
        pipeline=[dict(type='BGR2RGB'),
    ...
    # configs for the training pipeline
    test=dict(
        anno_path='Cityscapes_sequence/annotations/test_annotations.json',
        pipeline=[
               dict(type='BGR2RGB'),
