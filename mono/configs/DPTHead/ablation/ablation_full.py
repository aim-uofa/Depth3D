...
losses=dict(
    decoder_losses=[
        ...
        dict(type='SkyRegularizationLoss', loss_weight=1, sample_ratio=0.2, regress_value=250, disp_pred=True),
...
# online evaluation
evaluation = dict(online_eval=True, interval=5000, metrics=['abs_rel', 'delta1'])
