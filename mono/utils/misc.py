...
if str(torch.__version__).startswith('2.'): # pytorch 2.0
...
class NativeScalerWithGradNormCount:
    ...
    def __init__(self):
        self._scaler = torch.cuda.amp.GradScaler(init_scale=16384)
...
def is_bf16_supported():
    """Returns a bool indicating if the current CUDA devoce supports dtype bfloat16"""
